...
export const courseResourceCatalog: CourseResource[] = [
  { id: "autocare-aftermarket", provider: "Auto Care Association", title: "Aftermarket Essentials", url: "https://academy.autocare.org/courses/59792/", language: "英语", access: "自学课程；注册、费用与开放状态以页面为准", learn: "汽车售后市场生态、分销渠道、零部件制造商、批发商、零售与维修设施的角色。", task: "画出课程中的分销链，并与自己的刹车片采购链逐项比较。", note: "行业协会课程，适合 Day 1–3 建立汽车售后行业认知。" },
  ...
  { id: "icc-incoterms", provider: "International Chamber of Commerce", title: "Incoterms® 2020 官方概览", url: "https://iccwbo.org/business-solutions/incoterms-rules/incoterms-2020/", language: "英语；部分资料有多语言版本", access: "官方概览免费；完整规则与认证课程可能收费", learn: "贸易术语如何分配交付、任务、成本与风险，以及选择规则时的注意事项。", task: "比较 EXW、FCA、FOB、CIF 和 DAP 的交付点与风险转移，不凭简称猜含义。", note: "正式交易应使用 ICC 官方规则并结合合同专业核对。" },
  ...
  { id: "wto-intro", provider: "World Trade Organization", title: "Introduction to the WTO", url: "https://www.learning.wto.org/course/info.php?id=3", language: "英语及平台提供的其他语言", access: "自学课程；完整访问需注册", learn: "多边贸易体系、WTO 基本原则、协定与信息来源。", task: "完成导论后，用自己的话解释 WTO 规则与单笔产品进口要求的区别。", note: "宏观规则课程不能替代目标国的具体法规查询。" },
  ...
  { id: "itc-market-tools", provider: "International Trade Centre", title: "Market Analysis Tools Portal", url: "https://marketanalysis.intracen.org/en", language: "英语及多语言界面", access: "注册与免费范围以平台当前说明为准", learn: "Trade Map、Market Access Map 和 Export Potential Map 的用途与数据边界。", task: "选择产品编码与目标国，记录年度、进口值、数量、伙伴和口径，并写三条不能从数据推出的结论。", note: "总体贸易数据不能证明某家企业的采购意向。" },
  { id: "un-comtrade", provider: "United Nations Statistics Division", title: "UN Comtrade", url: "https://comtradeplus.un.org/TradeFlow", language: "英语", access: "公开查询；注册后功能和调用额度以平台说明为准", learn: "按报告国、伙伴、产品与年份查询货物贸易数据。", task: "用同一 HS 编码比较三个市场三年的进口趋势，并记录数据可用性。", note: "先核实 HS 编码；报告国与伙伴国数据可能存在口径差异。" },
...
export const resourceIdsByDay: Record<number, string[]> = {
  1: ["autocare-aftermarket", "trade-market-research"], 2: ["autocare-aftermarket", "itc-export-marketing"], 3: ["autocare-aftermarket", "trade-evaluate-reps"],
  4: ["trade-market-research", "salesforce-qualification"], 5: ["salesforce-qualification", "trade-due-diligence"], 6: ["trade-market-research", "trade-due-diligence"],
  7: ["trade-due-diligence", "trade-evaluate-reps"], 8: ["salesforce-qualification", "trade-evaluate-reps"], 9: ["salesforce-qualification", "trade-due-diligence"],
  10: ["trade-pricing", "icc-incoterms"], 11: ["trade-pricing", "icc-incoterms"], 12: ["icc-incoterms", "trade-pricing", "access2markets"],
  13: ["british-email", "wto-intro"], 14: ["british-email", "hubspot-sales"], 15: ["british-email", "hubspot-sales"],
  16: ["hubspot-sales", "salesforce-qualification"], 17: ["hubspot-sales", "salesforce-qualification"], 18: ["hubspot-sales", "british-email"],
  19: ["itc-market-tools", "un-comtrade", "trade-market-research"], 20: ["itc-market-tools", "un-comtrade", "trade-due-diligence"],
  21: ["trade-evaluate-reps", "salesforce-prospecting"], 22: ["salesforce-prospecting", "british-email"], 23: ["salesforce-prospecting", "hubspot-sales"],
  24: ["trade-export-plan", "itc-export-marketing"], 25: ["trade-due-diligence", "trade-export-plan"], 26: ["itc-export-marketing", "salesforce-prospecting"],
  27: ["trade-pricing", "trade-export-plan"], 28: ["trade-export-plan", "itc-export-marketing", "trade-due-diligence"],
};
