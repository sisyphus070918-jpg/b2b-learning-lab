...
export const resourceIdsByDay: Record<number, string[]> = {
  1: ["trade-ph-aftermarket", "trade-market-research"], 2: ["trade-ph-aftermarket", "itc-export-marketing"], 3: ["trade-ph-aftermarket", "trade-evaluate-reps"],
  ...
  10: ["trade-pricing", "trade-incoterms"], 11: ["trade-pricing", "trade-incoterms"], 12: ["trade-incoterms", "trade-pricing", "access2markets"],
  ...
  19: ["wto-stats", "un-comtrade", "trade-market-research"], 20: ["wto-stats", "un-comtrade", "trade-due-diligence"],
